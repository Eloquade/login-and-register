...
>
  ...
  <form class="flex flex-col justify-center items-center w-1/2" id="register-form"method="POST" action="<?php echo URLROOT; ?>/users/register">
    ...
    <small class="text-red-600"><?php echo $data['emailError']; ?></small>
    <div class="relative mt-8">
    ...
    <small class="text-red-600"><?php echo $data['confirmPasswordError']; ?></small>
    <br>
    <button 
      id="submit" 
      type="submit" 
    ...
    <br>
    <p class="font-bold"><b class="text-gray-600">Already have an account? </b><a href="<?php echo URLROOT; ?>/users/login" class="text-primarycolor" >Log in here!</a></p>
  </form>
</div>
